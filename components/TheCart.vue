    ...
    <div class="checkout__list">
      <div class="checkout__heading">
        ...
        <div class="box">
          ...
          <button class="clear-btn" @click="removeAll">Очистить корзину</button>
        </div>
      </div>
      ...
      <TheCartProduct
        ...
        @decrease="decrQuantity"
        @remove="removeProduct" />

      <div class="services" v-if="getCartArr.length">
        <label class="checkbox-label">
          <input
            type="checkbox"
            @change="setInstallation"
            :checked="isChecked" />
        </label>
        <div class="icon">
          <svg
...
export default {
  ...
  computed: {
    ...
    productsInCart() {
      return (
        this.cartTotalQuantity + " " + this.getEnding(this.cartTotalQuantity)
      );
    },
  },
  methods: {
